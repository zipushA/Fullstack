...
// import { Box, Card, Typography, Button, Link, CircularProgress } from '@mui/material';
...
//         responseType: 'blob', // מבקש לקבל את התשובה כ-binary blob
//       });
//       const link = document.createElement('a');
//       link.href = URL.createObjectURL(response.data); // הפיכת ה-binary ל-URL להורדה
//       link.download = url.split('/').pop() || 'file'; // מגדיר את שם הקובץ להורדה
...
//                 variant="contained"
//                 color="primary"
//                 onClick={() => handleDownload(teacher.link)}
//                 sx={{ ml: 2 }}
//               >
//                 הורד קובץ
//               </Button>
